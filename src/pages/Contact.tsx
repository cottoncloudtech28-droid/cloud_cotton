      ...
      <main className="container py-12 max-w-4xl">
        ...
        <div className="mt-8 grid md:grid-cols-2 gap-8">
          ...
          <div className="space-y-4">
            <div className="p-5 rounded-3xl bg-card shadow-soft flex items-start gap-3">
              <Mail className="h-5 w-5 text-primary mt-1" />
              <div>
                <p className="font-semibold">Email</p>
                <a className="text-sm text-muted-foreground hover:text-primary" href="mailto:hello@cottoncloud.co">hello@cottoncloud.co</a>
              </div>
            </div>
            <div className="p-5 rounded-3xl bg-card shadow-soft flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">@cottoncloudcompany</p>
              </div>
            </div>
            <div className="p-5 rounded-3xl bg-card shadow-soft flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">India · Ships worldwide</p>
              </div>
            </div>
          </div>
        </div>
