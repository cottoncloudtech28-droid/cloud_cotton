  ...
  return (
    <div className="min-h-screen">
      ...
      <main>
        ...
        <section className="container py-8 grid sm:grid-cols-3 gap-4">
          {[
            ...
            <div key={t} className="flex items-center gap-4 p-5 rounded-3xl bg-card shadow-soft">
              <div className="h-12 w-12 grid place-items-center rounded-2xl bg-gradient-primary text-primary-foreground"><I className="h-5 w-5" /></div>
